    ...
    <main className="bg-background min-h-screen text-secondary selection:bg-foreground selection:text-background overflow-x-hidden transition-colors duration-300">
      ...
      <div className="hidden md:block fixed bottom-0 left-10 z-10 text-secondary">
        <div className="flex flex-col items-center space-y-6 after:content-[''] after:block after:w-[1px] after:h-24 after:bg-secondary after:mt-6">
          <a href="#" className="hover:text-foreground hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="hidden md:block fixed bottom-0 right-10 z-10 text-secondary">
        <div className="flex flex-col items-center space-y-6 after:content-[''] after:block after:w-[1px] after:h-24 after:bg-secondary after:mt-6">
          <a href="mailto:hello@example.com" className="[writing-mode:vertical-rl] hover:text-foreground hover:-translate-y-1 transition-all duration-300 font-mono text-xs tracking-widest">
            hello@example.com
          </a>
        </div>
      </div>
